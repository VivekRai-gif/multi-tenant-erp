...
export default function Sidebar() {
  ...
  // Format name safely
  const formattedFirstName = parentFirstName ? parentFirstName[0].toUpperCase() + parentFirstName.slice(1) : 'Guardian';
  const formattedLastName = parentLastName ? parentLastName[0].toUpperCase() + parentLastName.slice(1) : '';
